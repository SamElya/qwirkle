...
import static g60731.qwirkle.model.Color.GREEN;
...
//    public static final Tile TILE_GREEN_DIAMOND = new Tile(GREEN, DIAMOND);
     ...
     * @return     an int
     */
    static int add2(Grid grid, int row, int col, Tile tile) {
     ...
     * @return     an int
     */
    static int add2(Grid grid, int row, int col, Direction d, Tile... line) {
